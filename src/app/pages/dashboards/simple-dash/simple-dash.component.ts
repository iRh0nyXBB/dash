...
import { PoChartOptions, PoChartSerie, PoChartType, PoDialogService } from '@po-ui/ng-components'
...
export class SimpleDashComponent {
  readonly participationByCountryInWorldExportsType: PoChartType = PoChartType.Line
  readonly evolutionOfCoffeeAndSomeCompetitorsType: PoChartType = PoChartType.Column
  readonly coffeConsumingChartType: PoChartType = PoChartType.Donut
  readonly consumptionPerCapitaType: PoChartType = PoChartType.Bar

  readonly categories: string[] = ['2010', '2011', '2012', '2013', '2014', '2015']
  readonly chartAreaCategories: string[] = ['Jan-18', 'Jul-18', 'Jan-19', 'Jul-19', 'Jan-20', 'Jul-20', 'Jan-21']
  readonly categoriesColumn: string[] = ['coffee', 'chocolate', 'tea']

  readonly consumptionPerCapitaItems: string[] = [
    'Water',
    'Fruit Juice',
    'Coffee',
    'Cola drinks',
  ...
  readonly chartAreaSeries: PoChartSerie[] = [
  ...
  readonly coffeeConsumption: PoChartSerie[] = [
  ...
  readonly consumptionPerCapita: PoChartSerie[] = [
  ...
  readonly participationByCountryInWorldExports: PoChartSerie[] = [
  ...
  readonly evolutionOfCoffeeAndSomeCompetitors: PoChartSerie[] = [
  ...
  readonly coffeeProduction: PoChartSerie[] = [
  ...
  readonly consumptionPerCapitaOptions: PoChartOptions = {
    axis: {
      maxRange: 100,
      gridLines: 2,
    },
  ...
  readonly chartAreaOptions: PoChartOptions = {
    axis: {
      maxRange: 700,
      gridLines: 8,
    },
  ...
  readonly options: PoChartOptions = {
    axis: {
      minRange: 0,
      maxRange: 40,
      gridLines: 5,
  ...
  readonly optionsColumn: PoChartOptions = {
    axis: {
      minRange: -20,
      maxRange: 100,
      gridLines: 7,
